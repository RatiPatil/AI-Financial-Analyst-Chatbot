...
genai.configure(api_key='AIzaSyCUG8m2_mfAWMVNEhfiH2mG7rZCk4iL-dw')
model = genai.GenerativeModel('gemini-pro')


#Function For get AI_Based output from LLM MOdel
...
st.subheader(" AI Market Trend Predictions By Ratikant")
